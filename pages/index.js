...
export default function Home(props) {
  ...
  return (
    <div className='indexContentWrapper'>
      ...
      {/*Still hardcoded */}<Grid Content={[{ Filler:"FillerGridImage2", GridPosition: "1" }, { GridTitle: "PHP", GridBody: "Uno de los mejores lenguajes de programacion, Aprovado por  Isaias", GridPosition: "6" }, {GridPosition: "3" ,Filler:"FillerGridItem"}, { GridTitle: "Working!", GridPosition: "4" }, {GridPosition: "5",Filler:"FillerGridImage1" }, { GridTitle: "Working EARLY!", GridPosition: "2" }]} />
