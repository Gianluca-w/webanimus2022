...
export default function Home(props) {
  ...
  return (
    <div className='indexContentWrapper'>
      <HeroSectionRemastered Slogan={t('AboutUs.slogan')} SubSlogan={t('AboutUs.SubSlogan')} OptionalAsteriskSize={'45px'} MainStyle={'About'} BackgroundImageSrc='AboutUsBackground.jpg' FullSize={true} FirstLinkText={t('PageAbout')} SecondLinkText={t('PageContact')} FirstLinkHref={'/about'} SecondLinkHref={'/contact'}/>
