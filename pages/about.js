...
export default function Home(props) {
  ...
  return (
    <div className='indexContentWrapper'>
      <HeroSection slogan={t('AboutUs.slogan')} MaxWidth={true} AlternativeTitleContent={t('AboutUs.SubSlogan')} BasicBackgroundStyle={'BaseAboutUs'} AsteriskSize='45px' BackgroundImageSrc='AboutUsBackground.jpg'/>
