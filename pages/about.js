...
export default function Home(props) {
  ...
  return (
    <div className='indexContentWrapper'>
      <HeroSectionRemastered Slogan={t('AboutUs.slogan')} SubSlogan={t('AboutUs.SubSlogan')} OptionalAsteriskSize={'45px'} MainStyle={'About'} BackgroundImageSrc='AboutUsBackground.jpg' FullSize={true} FirstLinkText={t('PageHome')} SecondLinkText={t('PageContact')} FirstLinkHref={'/'} SecondLinkHref={'/contact'}/>
      ...
      <LinksComponent />
      <DropdownMenu Items={[{Title:"Home", Position:1,Href:"/"},{Title:"Contact",Position:2,Href:"/contact"}]}/>
    </div>
  )
}
